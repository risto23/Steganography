...
public class Embedding {
   ...
   */
  @Nullable
  public static Bitmap embedSecretImage(Bitmap coverImage, Bitmap secretImage,String Password) {
    ...
    String password = HelperMethods.stringToBinaryStream(Password);
    int panjangPassword=password.length();

    String panjang_gambar_rahasia = Integer.toString(secretImageLen);
    Log.i("Panjang Gambar rahasia:",panjang_gambar_rahasia);
    int action, embImPos = 0, keyPos = 0, embPass=0;

    int width = coverImage.getWidth();
    int height = coverImage.getHeight();
    String width_cover = Integer.toString(width);
    Log.i("Width Cover :",width_cover);
    String height_cover = Integer.toString(height);
    ...
    Log.i("biner password:",password);
    Log.i("biner pesan:",sImageInBin);
   ...
   */
  @Nullable
  public static Bitmap embedSecretText(String secretText, Bitmap coverImage,String Password) {
    ...
    String panjang_pesan_rahasia = Integer.toString(secretMessageLen);
    Log.i("Panjang Pesan rahasia:",panjang_pesan_rahasia);
    int action, embMesPos = 0, keyPos = 0,embPass=0;
